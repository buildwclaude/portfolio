...
export const ITEMS = [
  ...
  // ── Art: from the "In my spare time, I enjoy making art" gallery on
  //    sony-thakuri.xyz/3/. Images live in /public/art/. ──
  {
    title: 'Orcas', tag: 'Pencil sketch', type: 'art',
    desc: 'A study from my sketchbook.',
    src: '/art/art-01.webp', fallback: 'moire', ratio: 0.634,
    detail: { hero: '/art/art-01.webp' },
  },
  {
    title: 'Botanical studies', tag: 'Pencil sketch', type: 'art',
    desc: 'A study from my sketchbook.',
    src: '/art/art-02.webp', fallback: 'rings', ratio: 0.609,
    detail: { hero: '/art/art-02.webp' },
  },
  {
    title: 'Tomato', tag: 'Pencil sketch', type: 'art',
    desc: 'A study from my sketchbook.',
    src: '/art/art-03.webp', fallback: 'strata', ratio: 0.940,
    detail: { hero: '/art/art-03.webp' },
  },
  {
    title: 'Portrait study I', tag: 'Pencil sketch', type: 'art',
    desc: 'A study from my sketchbook.',
    src: '/art/art-04.webp', fallback: 'dots', ratio: 0.691,
    detail: { hero: '/art/art-04.webp' },
  },
  {
    title: 'Profiles', tag: 'Pencil sketch', type: 'art',
    desc: 'A study from my sketchbook.',
    src: '/art/art-05.webp', fallback: 'grid', ratio: 0.584,
    detail: { hero: '/art/art-05.webp' },
  },
  {
    title: 'Portrait study II', tag: 'Pencil sketch', type: 'art',
    desc: 'A study from my sketchbook.',
    src: '/art/art-06.webp', fallback: 'field', ratio: 0.716,
    detail: { hero: '/art/art-06.webp' },
  },
  {
    title: 'Ribbon study', tag: 'Pencil sketch', type: 'art',
    desc: 'A study from my sketchbook.',
    src: '/art/art-07.webp', fallback: 'moire', ratio: 1.333,
    detail: { hero: '/art/art-07.webp' },
  },
  {
    title: 'Splashes', tag: 'Pencil sketch', type: 'art',
    desc: 'A study from my sketchbook.',
    src: '/art/art-08.webp', fallback: 'rings', ratio: 0.662,
    detail: { hero: '/art/art-08.webp' },
  },
  {
    title: 'Mushrooms', tag: 'Ink sketch', type: 'art',
    desc: 'A study from my sketchbook.',
    src: '/art/art-09.webp', fallback: 'strata', ratio: 1.392,
    detail: { hero: '/art/art-09.webp' },
  },
  {
    title: 'Eyes', tag: 'Pencil sketch', type: 'art',
    desc: 'A study from my sketchbook.',
    src: '/art/art-10.webp', fallback: 'dots', ratio: 1.415,
    detail: { hero: '/art/art-10.webp' },
  },
  {
    title: 'Jellyfish', tag: 'Pencil sketch', type: 'art',
    desc: 'A study from my sketchbook.',
    src: '/art/art-11.webp', fallback: 'grid', ratio: 0.719,
    detail: { hero: '/art/art-11.webp' },
  },
  {
    title: 'Plant studio', tag: 'Digital illustration', type: 'art',
    desc: 'A digital illustration, made in my spare time.',
    src: '/art/art-12.webp', fallback: 'field', ratio: 1.137,
    detail: { hero: '/art/art-12.webp' },
  },
  {
    title: 'Isometric room', tag: '3D render', type: 'art',
    desc: 'A 3D scene, modelled and lit in my spare time.',
    src: '/art/art-13.webp', fallback: 'moire', ratio: 1.000,
    detail: { hero: '/art/art-13.webp' },
  },
  {
    title: 'Bear hug', tag: 'Digital illustration', type: 'art',
    desc: 'A digital illustration, made in my spare time.',
    src: '/art/art-14.webp', fallback: 'rings', ratio: 0.847,
    detail: { hero: '/art/art-14.webp' },
  },
  {
    title: 'Isometric city', tag: '3D render', type: 'art',
    desc: 'A 3D scene, modelled and lit in my spare time.',
    src: '/art/art-15.webp', fallback: 'strata', ratio: 2.020,
    detail: { hero: '/art/art-15.webp' },
  },
  {
    title: 'Totoro', tag: 'Digital illustration', type: 'art',
    desc: 'A digital illustration, made in my spare time.',
    src: '/art/art-16.webp', fallback: 'dots', ratio: 0.777,
    detail: { hero: '/art/art-16.webp' },
  },
];
